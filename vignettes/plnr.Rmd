...
+======================+===========================================================================================+
| Single-function plan | Same function applied multiple times with different argsets applied to the same datasets. |
+----------------------+-------------------------------------------------------------------------------------------+
...
-   **Single-function plans:** One function (e.g. `table_1`) called multiple times with different argsets (e.g. `year=2019`, `year=2020`).
-   **Multi-function plans:** Multiple functions (e.g. `table_1`, `table_2`) called multiple times with different argsets (e.g. `table_1`: `year=2019`, while for `table_2`: `year=2019` and `year=2020`)
...
We now provide a simple example of a single-function plan that shows how a person can develop code to provide graphs for multiple years. More examples are provided inside the vignette [Adding Analyses to a Plan](http://docs.sykdomspulsen.no/plnr/articles/adding_analyses.html).
...
p$apply_analysis_fn_to_all(fn_name = "fn_fig_1")
