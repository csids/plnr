...
The function `get_data` will automatically compute the [spookyhash](https://github.com/k0dai/spookyhash) via digest::digest for:
...
# The hash for the entire named list ('current') is different for p1 vs p2
# because p1 has 3 datasets while p2 only has 2.
#
# The hashes for p1 'deaths', p1 'deaths2', p2 'deaths', and p2 'deaths2'
# are all identical, because the content is the same.
p2$get_data()$hash
```
