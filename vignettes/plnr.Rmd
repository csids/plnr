...
We now provide a simple example of a single-function plan that shows how a person can develop code to provide graphs for multiple years. More examples are provided inside the vignette [Adding Analyses to a Plan](http://docs.sykdomspulsen.no/plnr/articles/plnr.html).
